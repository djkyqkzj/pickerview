 ...
 */
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener, OnItemScollStopListener {
    ...
    private void initView(Context context) {
        ...
        wheelOptions.setOnItemScollStopListener(this);
    ...
    public void OnItemScollStop() {
        if (onScollStopListener != null) {
            int[] optionsCurrentItems = wheelOptions.getCurrentItems();
            onScollStopListener.OnItemScollStop(optionsCurrentItems, clickView);
        }
    }
}
