...
public class WheelOptions<T> implements OnItemScollStopListener {
    private View view;
    ...
    private void setScorllStopListener() {
        wv_option1.setOnItemScollStopListener(this);
        wv_option2.setOnItemScollStopListener(this);
        wv_option3.setOnItemScollStopListener(this);
