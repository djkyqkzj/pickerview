...
import com.bigkoo.pickerview.listener.OnItemScollStopListener;
...
public class WheelTime implements OnItemScollStopListener {
    ...
    private OnItemScollStopListener onItemScollStopListener;
    ...
    private void setScorllStopListener() {
        wv_year.setOnItemScollStopListener(this);
        wv_month.setOnItemScollStopListener(this);
        wv_day.setOnItemScollStopListener(this);
        wv_hours.setOnItemScollStopListener(this);
        wv_mins.setOnItemScollStopListener(this);
        wv_seconds.setOnItemScollStopListener(this);

    }

    @Override
    public void OnItemScollStop() {
        if (onItemScollStopListener != null)
            onItemScollStopListener.OnItemScollStop();
    }

    public final void setOnItemScollStopListener(OnItemScollStopListener onItemScollStopListener) {
        this.onItemScollStopListener = onItemScollStopListener;
    }
