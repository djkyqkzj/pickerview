...
public class WheelView extends View {
    ...
    OnItemScollStopListener onItemScollStopListener;
        ...
        public final void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case WHAT_SMOOTH_SCROLL:
                    WheelView.this.smoothScroll(ACTION.FLING);
                    break;
            ...
            if (onItemScollStopListener != null) onItemScollStopListener.OnItemScollStop();
        }
    };
    ...
    int textColorCenter = 0xFFe53770;
    int dividerColor = 0xFFcccccc;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                reMeasureTextSize(contentText, radian);
                //计算开始绘制的位置
     ...
     * @param radian
     */
    private void reMeasureTextSize(String contentText, double radian) {
        Rect rect = new Rect();
        paintCenterText.getTextBounds(contentText, 0, contentText.length(), rect);
        int width = rect.width();
        int abs = Math.abs(5 - (int) (radian * 10 / 3));
        int size = textSize - abs * 3;
